    ...
    async adicionarEndereco(data) {
        try {
            ...
            let result = await connection.execute(
                `INSERT INTO enderecos (id_usuario, logradouro, tipo_logradouro, numero, bairro, cidade, estado, pais, cep, tipo_residencia, observacoes, identificacao, tipo_endereco)
                 VALUES (:id_usuario, :logradouro, :tipo_logradouro, :numero, :bairro, :cidade, :estado, :pais, :cep, :tipo_residencia, :observacoes, :identificacao, :tipo_endereco)`,
                {
                    id_usuario: data.idCliente,
